...
<body>
	...
	<form name="insertfaq_form" action="${pageContext.request.contextPath}/faq_writeProcess.do" method="post">
	...
	<tbody>
		...
		<a class='btn btn-primary' href='${pageContext.request.contextPath}/faq_update.do?fidx=${faqVo.fidx}'>수정하기</a>
		<a class='btn btn-primary' href='${pageContext.request.contextPath}/faq_delyn.do?fidx=${faqVo.fidx}'>삭제하기</a>
		
		</c:if>
		<a href="${pageContext.request.contextPath}/faq_board.do" class="btn btn-primary">글목록</a>
		</c:if>
		</div>
