...
<!-- Navigation-->
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">JPK2</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <!-- 
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="#about">회원가입</a></li>
...
<!-- <div id="userMenu">
	<div id="list_menu">
		...
		<li id="menu none_sub menu_login">
			<a href="" >로그인</a>
			|
		</li>
		<li id="menu lst">
