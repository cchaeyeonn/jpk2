...
public class MemberVo {
	...
	public int getMember_term1() {
		return member_term1;
	}
	public void setMember_term1(int member_term1) {
		this.member_term1 = member_term1;
	}
	public int getMember_term2() {
		return member_term2;
	}
	public void setMember_term2(int member_term2) {
		this.member_term2 = member_term2;
	}
