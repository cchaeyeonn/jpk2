...
public class ProductVo {
	...
	public String getD_addrcode() {
		return d_addrcode;
	}
	public void setD_addrcode(String d_addrcode) {
		this.d_addrcode = d_addrcode;
	}
	...
	public String getP_limitdate() {
		return p_limitdate;
	}
	public void setP_limitdate(String p_limitdate) {
		this.p_limitdate = p_limitdate;
	}
